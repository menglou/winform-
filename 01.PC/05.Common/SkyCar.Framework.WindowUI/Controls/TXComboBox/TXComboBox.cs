...
namespace SkyCar.Framework.WindowUI.Controls
{
    ...
    public class TXComboBox : ComboBox
    {
        ...
        {
            return TX.Framework.Convert.ToDateTimeOrNull(this.Value);
        }
        #endregion
        ...
        public Guid ToGuid()
        {
            return TX.Framework.Convert.ToGuid(this.Value);
        }
        #endregion
        ...
        public int ToInt()
        {
            return TX.Framework.Convert.ToInt(this.Value);
        }
        #endregion
        ...
        public long ToLong()
        {
            return TX.Framework.Convert.ToLong(this.Value);
        }
        #endregion
        ...
        public bool ToBool()
        {
            return TX.Framework.Convert.ToBool(this.Value);
        }
        #endregion
        ...
        {
            return TX.Framework.Convert.ToFloat(this.Value);
        }
        #endregion
        ...
        {
            return TX.Framework.Convert.ToDouble(this.Value, decimals);
        }
        #endregion
        ...
        {
            return TX.Framework.Convert.ToDecimal(this.Value, decimals);
        }
        #endregion
        ...
        {
            return TX.Framework.Convert.ConvertTo<T>(this.Value);
        }
        #endregion
