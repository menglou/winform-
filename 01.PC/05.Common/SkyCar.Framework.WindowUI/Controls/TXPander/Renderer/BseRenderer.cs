...
namespace SkyCar.Framework.WindowUI.Controls
{
    ...
    public class BseRenderer : ToolStripProfessionalRenderer
    {
        ...
        /// </summary>
        public BseRenderer()
            : base(new SkyCar.Framework.WindowUI.Controls.ColorTableBlack())
        {
        ...
        /// </summary>
        /// <param name="professionalColorTable">A <see cref="SkyCar.Framework.WindowUI.Controls.ProfessionalColorTable"/> to be used for painting.</param>
        ...
        protected override void OnRenderArrow(ToolStripArrowRenderEventArgs e)
        {
            ...
            {
                ProfessionalColorTable colorTable = ColorTable as SkyCar.Framework.WindowUI.Controls.ProfessionalColorTable;
