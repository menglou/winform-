namespace SkyCar.Framework.WindowUI.Controls
{
    partial class frmAddImage
    {
        ...
        {
            this.rBtn_URL = new SkyCar.Framework.WindowUI.Controls.TXRadioButton();
            this.rBtn_Local = new SkyCar.Framework.WindowUI.Controls.TXRadioButton();
            this.txt_URL = new SkyCar.Framework.WindowUI.Controls.TXTextBox();
            this.btn_LocalImageUpdate = new SkyCar.Framework.WindowUI.Controls.TXButton();
            this.txtFileName = new SkyCar.Framework.WindowUI.Controls.TXTextBox();
