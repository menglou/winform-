...
namespace SkyCar.Coeus.Common.CustomControl
{
    ...
    /// 准确但是耗时
    /// </summary>
    public class ChineseSpellCode1
    {
        #region 中文首拼音
        /// <summary>
        ...
        public static string GetShortSpellCode(string paramContent)
        {
            try
            {
        ...
        /// <returns></returns>
        public static string GetFirstSpellCode(string strText)
        {
        ...
        /// </summary>
        /// <param name="paramContent">字符串</param>
        /// <returns>转换后的拼音(全拼)字符串</returns> 
        public static string GetFullSpellCode(string paramContent)
        {
            try
            {
                if (paramContent.Length != 0)
        ...
        private static string GetSpell(char paramChar)
        {
            var coverchr = NPinyin.Pinyin.GetPinyin(paramChar);
