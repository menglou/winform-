...
namespace SkyCar.Coeus.UI.SD
{
    ...
    /// 打印销售订单
    /// </summary>
    public partial class FrmViewAndPrintSalesReturn : BaseForm
    {
        #region 全局变量
        ...
        /// 构造方法
        /// </summary>
        public FrmViewAndPrintSalesReturn()
        {
            InitializeComponent();
        }
        ...
        /// 构造方法
        /// </summary>
        public FrmViewAndPrintSalesReturn(Dictionary<string, object> paramViewParameters)
        {
            InitializeComponent();
        ...
        /// <param name="e"></param>
        private void FrmViewAndPrintSalesReturn_Load(object sender, EventArgs e)
        {
        ...
        private void LoadSalesOrder(BillPaperSize paramBillPaperSize)
        {
            ...
            switch (paramBillPaperSize)
            {
                case BillPaperSize.CustomerSize:
                    rdlcFileName = "SD_ViewAndPrintSalesReturn2228_" + @".rdlc";
                    break;
                case BillPaperSize.A4Size:
                    rdlcFileName = "SD_ViewAndPrintSalesReturn_" + @".rdlc";
                    break;
                case BillPaperSize.A5Size:
                    rdlcFileName = "SD_ViewAndPrintSalesReturnA5_" + @".rdlc";
                    break;
                case BillPaperSize.A4SizeFull:
                    rdlcFileName = "SD_ViewAndPrintSalesReturnA4Full_" + @".rdlc";
                    break;
            }
            ...
            if (!File.Exists(reportFilePath))
            {
                ...
                {
                    case BillPaperSize.CustomerSize:
                        reportFilePath = Application.StartupPath + @"\RdlcFiles\SD_ViewAndPrintSalesReturn2228.rdlc";
                        break;
                    case BillPaperSize.A4Size:
                        reportFilePath = Application.StartupPath + @"\RdlcFiles\SD_ViewAndPrintSalesReturn.rdlc";
                        break;
                    case BillPaperSize.A5Size:
                        reportFilePath = Application.StartupPath + @"\RdlcFiles\SD_ViewAndPrintSalesReturnA5.rdlc";
                        break;
                    case BillPaperSize.A4SizeFull:
                        reportFilePath = Application.StartupPath + @"\RdlcFiles\SD_ViewAndPrintSalesReturnA4Full.rdlc";
                        break;
                }
            }
            if (File.Exists(reportFilePath))
            {
                ...
                ReportParameter rp12 = new ReportParameter("SalesOrderSourceNo", _salesOrder.SO_SourceNo);
