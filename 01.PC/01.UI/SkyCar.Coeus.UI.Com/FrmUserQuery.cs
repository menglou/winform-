...
namespace SkyCar.Coeus.UI.Common
{
    ...
    /// 用户查询
    /// </summary>
    public partial class FrmUserQuery : BaseForm
    {
        #region 全局变量
        /// <summary>
        /// 用户查询BLL
        ...
        /// Grid的数据源
        /// </summary>
        List<UserQueryUIModel> ListGridDS = new List<UserQueryUIModel>();
        ...
        /// 选中项列表
        /// </summary>
        public List<MDLSM_User> SelectedGridList = new List<MDLSM_User>();
        #endregion
        ...
        {
            _bll.QueryForList<UserQueryUIModel>(SQLID.COMM_SQL08, new UserQueryQCModel()
            {
                PageSize = PageSize,
                PageIndex = PageIndex,
                //用户姓名
                ...
                //组织ID
                WHERE_Org_ID = txtWhere_Org_Name.Tag.ToString(),
                //组织简称
        ...
        private void InitializeListTabControls()
        {
            ...
            //清空Grid
            ListGridDS = new List<UserQueryUIModel>();
            gdGrid.DataSource = ListGridDS;
            gdGrid.DataBind();

            //设置父类别
            this.txtWhere_Org_Name.Text = SelectedItemParentText;
            this.txtWhere_Org_Name.Tag = !string.IsNullOrEmpty(SelectedItemParentValue) ? SelectedItemParentValue : string.Empty;
            this.txtWhere_Org_Name.ReadOnly = !string.IsNullOrEmpty(SelectedItemParentValue);
            this.txtWhere_Org_Name.Enabled = string.IsNullOrEmpty(SelectedItemParentValue);
        }
