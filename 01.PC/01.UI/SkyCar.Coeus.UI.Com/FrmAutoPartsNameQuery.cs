...
namespace SkyCar.Coeus.UI.Common
{
    ...
    /// 配件名称查询
    /// </summary>
    public partial class FrmAutoPartsNameQuery : BaseForm
    {
        #region 全局变量
        /// <summary>
        /// 配件名称查询BLL
        ...
        /// Grid的数据源
        /// </summary>
        List<AutoPartsNameQueryUIModel> ListGridDS = new List<AutoPartsNameQueryUIModel>();
        ...
        public FrmAutoPartsNameQuery(string paramSelectedValuePropertyName,
        ...
        /// <param name="e"></param>
        private void FrmAutoPartsNameQuery_Load(object sender, EventArgs e)
        {
            #region 固定
            //基类.工具栏（翻页）
        ...
        {
            _bll.QueryForList<AutoPartsNameQueryUIModel>(SQLID.COMM_SQL12, new AutoPartsNameQueryQCModel()
            {
                PageSize = PageSize,
                PageIndex = PageIndex,
                //配件名称
        ...
        private void InitializeListTabControls()
        {
            ...
            //清空Grid
            ListGridDS = new List<AutoPartsNameQueryUIModel>();
            gdGrid.DataSource = ListGridDS;
            gdGrid.DataBind();
