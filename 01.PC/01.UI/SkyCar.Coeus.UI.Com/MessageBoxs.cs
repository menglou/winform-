...
namespace SkyCar.Coeus.UI.Common
{
    ...
    public class MessageBoxs
    {
        ...
        public static DialogResult Show(string paramBussID, string paramOwner, string paramMsg, MessageBoxButtons paramMsgBtn, MessageBoxIcon paramMsgBtnIcon)
        {
            LogHelper.WriteBussLog(paramBussID, LoginInfoDAX.UserName, paramOwner, paramMsg, "", null);

            return MessageBox.Show(paramMsg, SysConst.CHS_MSG_TITLE, paramMsgBtn, paramMsgBtnIcon);
        }
        /// <summary>
        /// 弹出消息框
        /// </summary>
        ...
        public static DialogResult Show(string paramBussID, string paramOwner, string paramMsg)
        {
            ...
            return MessageBox.Show(paramMsg, SysConst.CHS_MSG_TITLE, MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
    }
}
