...
namespace SkyCar.Coeus.UI.Common
{
    ...
    /// 主动销售模板查询
    /// </summary>
    public partial class FrmSalesTemplateQuery : BaseForm
    {
        #region 全局变量
        /// <summary>
        /// 主动销售模板查询BLL
        ...
        /// Grid的数据源
        /// </summary>
        List<SalesTemplateQueryUIModel> ListGridDS = new List<SalesTemplateQueryUIModel>();
        ...
        /// 选中项列表
        /// </summary>
        public List<MDLSD_SalesTemplate> SelectedGridList = new List<MDLSD_SalesTemplate>();
        #endregion
        ...
        public FrmSalesTemplateQuery(CustomEnums.CustomeSelectionMode paramCustomeSelectionMode = CustomEnums.CustomeSelectionMode.Single, string paramItemSelectedItemParentValue = null, string paramItemSelectedItemParentText = null)
        {
        ...
        /// <param name="paramCustomeSelectionMode">选择模式，默认单选</param>
        public FrmSalesTemplateQuery(Dictionary<string, object> paramWindowParameters, CustomEnums.CustomeSelectionMode paramCustomeSelectionMode = CustomEnums.CustomeSelectionMode.Single)
        {
            ListSelectionMode = paramCustomeSelectionMode;
        ...
        /// <param name="e"></param>
        private void FrmSalesTemplateQuery_Load(object sender, EventArgs e)
        {
            #region 固定
            //基类.工具栏（翻页）
            ...
            if (_viewParameters != null)
            {
                ...
                {
                    txtWhere_SasT_CustomerName.Text = _viewParameters[ComViewParamKey.CustomerName.ToString()] as string;
                    txtWhere_SasT_CustomerName.Enabled = false;
                }
                if (_viewParameters.ContainsKey(ComViewParamKey.CustomerId.ToString()))
                {
                    txtWhere_SasT_CustomerName.Tag = _viewParameters[ComViewParamKey.CustomerId.ToString()] as string;
                }
                #endregion

                #region 汽修商户组织

                if (_viewParameters.ContainsKey(ComViewParamKey.AutoFactoryOrgName.ToString()))
                {
                    txtWhere_AutoFactoryOrgName.Text = _viewParameters[ComViewParamKey.AutoFactoryOrgName.ToString()] as string;
                    txtWhere_AutoFactoryOrgName.Enabled = false;
                }
                if (_viewParameters.ContainsKey(ComViewParamKey.AutoFactoryOrgId.ToString()))
                {
                    txtWhere_AutoFactoryOrgName.Tag = _viewParameters[ComViewParamKey.AutoFactoryOrgId.ToString()] as string;
                }
                #endregion
                ...
                {
                    cbWhere_SasT_ApprovalStatusName.Text = _viewParameters[ComViewParamKey.ApprovalStatus.ToString()] as string;
                    cbWhere_SasT_ApprovalStatusName.Enabled = false;
                }
        ...
        private void btnClearSelectedItem_Click(object sender, EventArgs e)
        {
            ...
            this.gdGrid.Refresh();
            SelectedGridList = new List<MDLSD_SalesTemplate>();
        }
        ...
        {
            _bll.QueryForList<SalesTemplateQueryUIModel>(SQLID.COMM_SQL29, new SalesTemplateQueryQCModel()
            {
                PageSize = PageSize,
                PageIndex = PageIndex,
                //组织
                ...
                //客户ID
                WHERE_SasT_CustomerID = txtWhere_SasT_CustomerName.Tag?.ToString(),
                //客户名称
                WHERE_SasT_CustomerName = txtWhere_SasT_CustomerName.Text.Trim(),
                //汽修商商户组织ID
                WHERE_AutoFactoryOrgID = txtWhere_AutoFactoryOrgName.Tag?.ToString(),
                //汽修商户组织名称
                WHERE_AutoFactoryOrgName = txtWhere_AutoFactoryOrgName.Text.Trim(),
                //审核状态名称
                WHERE_SasT_ApprovalStatusName = cbWhere_SasT_ApprovalStatusName.Text.Trim()
            }, ListGridDS);
        ...
        void GenerateSelectedValueAndText()
        {
            ...
            foreach (var loopSourceItem in ListGridDS)
            {
                ...
                {
                    SasT_ID = loopSourceItem.SasT_ID,
                    SasT_Name = loopSourceItem.SasT_Name,
                    SasT_Org_ID = loopSourceItem.SasT_Org_ID,
                    SasT_CustomerID = loopSourceItem.SasT_CustomerID,
                    SasT_CustomerName = loopSourceItem.SasT_CustomerName,
                    SasT_ApprovalStatusCode = loopSourceItem.SasT_ApprovalStatusCode,
                    SasT_ApprovalStatusName = loopSourceItem.SasT_ApprovalStatusName,
                    SasT_Remark = loopSourceItem.SasT_Remark,
                    SasT_IsValid = loopSourceItem.SasT_IsValid,
                    SasT_CreatedBy = loopSourceItem.SasT_CreatedBy,
                    SasT_CreatedTime = loopSourceItem.SasT_CreatedTime,
                    SasT_UpdatedBy = loopSourceItem.SasT_UpdatedBy,
                    SasT_UpdatedTime = loopSourceItem.SasT_UpdatedTime,
                    SasT_VersionNo = loopSourceItem.SasT_VersionNo
                };
                SelectedGridList.Add(argsSalesTemplate);
            }
        }
