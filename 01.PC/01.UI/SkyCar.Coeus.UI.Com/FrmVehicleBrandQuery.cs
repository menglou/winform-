...
namespace SkyCar.Coeus.UI.Common
{
    ...
    /// 车辆品牌查询
    /// </summary>
    public partial class FrmVehicleBrandQuery : BaseForm
    {
        #region 全局变量
        /// <summary>
        /// 车辆品牌车系查询BLL
        ...
        /// Grid的数据源
        /// </summary>
        List<VehicleBrandQueryUIModel> ListGridDS = new List<VehicleBrandQueryUIModel>();
        ...
        public FrmVehicleBrandQuery(string paramSelectedValuePropertyName,
        ...
        /// <param name="e"></param>
        private void FrmVehicleBrandQuery_Load(object sender, EventArgs e)
        {
            #region 固定
            //基类.工具栏（翻页）
        ...
        {
            _bll.QueryForList<VehicleBrandQueryUIModel>(SQLID.COMM_SQL09, new VehicleBrandQueryQCModel()
            {
                PageSize = PageSize,
                PageIndex = PageIndex,
                //车辆品牌
        ...
        private void InitializeListTabControls()
        {
            ...
            //给 车辆品牌 设置焦点
            lblWhere_VBIS_Brand.Focus();

            #endregion

            //清空Grid
            ListGridDS = new List<VehicleBrandQueryUIModel>();
            gdGrid.DataSource = ListGridDS;
            gdGrid.DataBind();
        }
