...
namespace SkyCar.Coeus.UI.Common
{
    ...
    /// 配件品牌查询
    /// </summary>
    public partial class FrmAutoPartsBrandQuery : BaseForm
    {
        #region 全局变量
        /// <summary>
        /// 配件品牌查询BLL
        ...
        /// Grid的数据源
        /// </summary>
        List<AutoPartsBrandQueryUIModel> ListGridDS = new List<AutoPartsBrandQueryUIModel>();
        ...
        public FrmAutoPartsBrandQuery(string paramSelectedValuePropertyName,
        ...
        /// <param name="e"></param>
        private void FrmAutoPartsBrandQuery_Load(object sender, EventArgs e)
        {
            #region 固定
            //基类.工具栏（翻页）
        ...
        {
            _bll.QueryForList<AutoPartsBrandQueryUIModel>(SQLID.COMM_SQL14, new AutoPartsBrandQueryQCModel()
            {
                PageSize = PageSize,
                PageIndex = PageIndex,
                //配件名称
        ...
        private void InitializeListTabControls()
        {
            ...
            //清空Grid
            ListGridDS = new List<AutoPartsBrandQueryUIModel>();
            gdGrid.DataSource = ListGridDS;
            gdGrid.DataBind();
            ...
            //设置父类别
            txtWhere_APA_Name.Text = SelectedItemParentValue;
            txtWhere_APA_Name.ReadOnly = !string.IsNullOrEmpty(SelectedItemParentValue);
            txtWhere_APA_Name.Enabled = string.IsNullOrEmpty(SelectedItemParentValue);
        }
