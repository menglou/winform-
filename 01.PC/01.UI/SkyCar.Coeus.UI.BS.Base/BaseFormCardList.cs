...
namespace SkyCar.Coeus.UI.Base
{
    ...
    public partial class BaseFormCardList<UIModelType, QCModelType, TBModeType> : Form
    {
        #region 私有变量
        ...
        private UIModelType _detailDSCopy;
        /// <summary>
        /// 【详情】Tab内控件绑定用的数据源备份
        /// </summary>
        public UIModelType DetailDSCopy
        {
            get { return _detailDSCopy; }
            set
            {
                _detailDSCopy = value;
            }
        ...
        /// 基础窗体（列表-详情）
        /// </summary>
        public BaseFormCardList()
        {
            InitializeComponent();
            //实例化ConditionDS
            ConditionDS = Activator.CreateInstance<QCModelType>();
        }
        private void BaseFormCardList_Load(object sender, EventArgs e)
        {
        ...
        public void toolBarActionAndNavigate_ToolClick(object sender, ToolClickEventArgs e)
        {
            switch (e.Tool.Key)
            {
                ...
                case SystemActionEnum.Code.ANALYSE:
                    ...
                    break;
                //充值
                case SystemActionEnum.Code.RECHARGE:
                    RechargeAction();
                    break;
                //提现
                case SystemActionEnum.Code.WITHDRAWCASH:
                    WithdrawCashAction();
                    break;
                //销户
                case SystemActionEnum.Code.CLOSEACCOUNT:
                    CloseAccountAction();
                    break;
                #endregion
        ...
        /// 充值
        /// </summary>
        public virtual void RechargeAction() { }
        /// <summary>
        /// 提现
        /// </summary>
        public virtual void WithdrawCashAction() { }
        /// <summary>
        /// 销户
        /// </summary>
        public virtual void CloseAccountAction() { }
        #endregion
        ...
        public void AcceptUIModelChanges(string paramPropertyName)
        {
            ...
            _bll.CopyModelByPropertyName(this.DetailDS, OrginalUIModel, paramPropertyName);
        }
