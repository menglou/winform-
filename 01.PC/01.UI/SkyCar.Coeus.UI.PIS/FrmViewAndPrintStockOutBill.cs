...
namespace SkyCar.Coeus.UI.PIS
{
    ...
    /// 打印出库单
    /// </summary>
    public partial class FrmViewAndPrintStockOutBill : BaseForm
    {
        #region 全局变量
        ...
        /// 构造方法
        /// </summary>
        public FrmViewAndPrintStockOutBill()
        {
            InitializeComponent();
        }
        /// <summary>
        /// 构造方法
        /// </summary>
        public FrmViewAndPrintStockOutBill(Dictionary<string, object> paramViewParameters)
        {
            InitializeComponent();
        ...
        /// <param name="e"></param>
        private void FrmViewAndPrintStockOutBill_Load(object sender, EventArgs e)
        {
        ...
        private void LoadStockOutBill(BillPaperSize paramBillPaperSize)
        {
            reportViewer1.Reset();
            ...
            switch (paramBillPaperSize)
            {
                case BillPaperSize.CustomerSize:
                    rdlcFileName = "PIS_ViewAndPrintStockOutBill2228_" + @".rdlc";
                    break;
                case BillPaperSize.A4Size:
                    rdlcFileName = "PIS_ViewAndPrintStockOutBill_" + @".rdlc";
                    break;
                case BillPaperSize.A5Size:
                    rdlcFileName = "PIS_ViewAndPrintStockOutBillA5_" + @".rdlc";
                    break;
                case BillPaperSize.A4SizeFull:
                    rdlcFileName = "PIS_ViewAndPrintStockOutBillA4Full_" + @".rdlc";
                    break;
            }
            ...
            if (!File.Exists(reportFilePath))
            {
                ...
                {
                    case BillPaperSize.CustomerSize:
                        reportFilePath = Application.StartupPath + @"\RdlcFiles\PIS_ViewAndPrintStockOutBill2228.rdlc";
                        break;
                    case BillPaperSize.A4Size:
                        reportFilePath = Application.StartupPath + @"\RdlcFiles\PIS_ViewAndPrintStockOutBill.rdlc";
                        break;
                    case BillPaperSize.A5Size:
                        reportFilePath = Application.StartupPath + @"\RdlcFiles\PIS_ViewAndPrintStockOutBillA5.rdlc";
                        break;
                    case BillPaperSize.A4SizeFull:
                        reportFilePath = Application.StartupPath + @"\RdlcFiles\PIS_ViewAndPrintStockOutBillA4Full.rdlc";
                        break;
                }
            }
            if (File.Exists(reportFilePath))
