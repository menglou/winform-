...
namespace SkyCar.Coeus.UI.RPT
{
    ...
    /// 打印入库明细表
    /// </summary>
    public partial class FrmViewAndPrintStockInDetailReport : BaseForm
    {
        #region 全局变量
        ...
        /// 入库明细数据
        /// </summary>
        List<AutoPartsStockInDetailReportUIModel> _stockInDetailList = new List<AutoPartsStockInDetailReportUIModel>();
        ...
        /// 构造方法
        /// </summary>
        public FrmViewAndPrintStockInDetailReport()
        {
            InitializeComponent();
        }
        /// <summary>
        /// 构造方法
        /// </summary>
        public FrmViewAndPrintStockInDetailReport(Dictionary<string, object> paramViewParameters)
        {
            InitializeComponent();
        ...
        /// <param name="e"></param>
        private void FrmViewAndPrintStockInDetailReport_Load(object sender, EventArgs e)
        {
            if (_viewParameters != null)
            {
                ...
                {
                    _stockInDetailList = _viewParameters[ComViewParamKey.APModel.ToString()] as List<AutoPartsStockInDetailReportUIModel>;
                }
                #endregion
            }
            else
        ...
        private void LoadStockInDetailReport(SettleBillPaperSize paramBillPaperSize)
        {
            reportViewer1.Reset();
            ...
            switch (paramBillPaperSize)
            {
                case SettleBillPaperSize.CustomerSize:
                    rdlcFileName = "RPT_ViewAndPrintStockInDetailReport2228_" + @".rdlc";
                    break;
                case SettleBillPaperSize.A4Size:
                    rdlcFileName = "RPT_ViewAndPrintStockInDetailReport_" + @".rdlc";
                    break;
                case SettleBillPaperSize.A5Size:
                    rdlcFileName = "RPT_ViewAndPrintStockInDetailReportA5_" + @".rdlc";
                    break;
                case SettleBillPaperSize.A4SizeFull:
                    rdlcFileName = "RPT_ViewAndPrintStockInDetailReportA4Full_" + @".rdlc";
                    break;
            }
            ...
            if (!File.Exists(reportFilePath))
            {
                ...
                {
                    case SettleBillPaperSize.CustomerSize:
                        reportFilePath = Application.StartupPath + @"\RdlcFiles\RPT_ViewAndPrintStockInDetailReport2228.rdlc";
                        break;
                    case SettleBillPaperSize.A4Size:
                        reportFilePath = Application.StartupPath + @"\RdlcFiles\RPT_ViewAndPrintStockInDetailReport.rdlc";
                        break;
                    case SettleBillPaperSize.A5Size:
                        reportFilePath = Application.StartupPath + @"\RdlcFiles\RPT_ViewAndPrintStockInDetailReportA5.rdlc";
                        break;
                    case SettleBillPaperSize.A4SizeFull:
                        reportFilePath = Application.StartupPath + @"\RdlcFiles\RPT_ViewAndPrintStockInDetailReportA4Full.rdlc";
                        break;
                }
            }
            if (File.Exists(reportFilePath))
            {
                ...
                ReportDataSource rpd1 = new ReportDataSource("StockInDetail", _stockInDetailList as object);
