...
namespace SkyCar.Coeus.UIModel.PIS
{
    ...
    /// 采购订单管理明细UIModel
    /// </summary>
    public class PurchaseOrderManagerDetailUIModel : BaseNotificationUIModel
    {
        #region 私有变量
        /// <summary>
        /// 订单号
        ...
        private Decimal? _thisReceivedQty;
        /// <summary>
        /// 本次签收数量
        /// </summary>
        public Decimal? ThisReceivedQty
        {
            get { return _thisReceivedQty; }
            set
            {
                _thisReceivedQty = value;
                RaisePropertyChanged(() => ThisReceivedQty);
            }
        }
        /// <summary>
        /// 临时ID
        /// </summary>
        public string Tmp_POD_ID { get; set; }
