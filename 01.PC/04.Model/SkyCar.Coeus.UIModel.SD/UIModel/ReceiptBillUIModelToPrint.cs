...
namespace SkyCar.Coeus.UIModel.SD
{
    ...
    /// UIModel
    /// </summary>
    public class ReceiptBillUIModelToPrint : BaseNotificationUIModel
    {
        /// <summary>
        /// 选择
        /// </summary>
        ...
        /// 收款通道编码
        /// </summary>
        public String RB_PaymentChannelCode { get; set; }
        /// <summary>
        /// 收款通道名称
        /// </summary>
        public String RB_PaymentChannelName { get; set; }
        /// <summary>
        /// 付款方账号
        /// </summary>
        public String RB_PayAccount { get; set; }
        /// <summary>
        /// 付款凭证编号
        /// </summary>
